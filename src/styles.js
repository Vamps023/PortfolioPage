const styles = {
  ...
  // Fancy animations and hover effects
  fancyButton: `
    bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold py-3 px-6 rounded-full
    transform transition-transform hover:scale-110 hover:shadow-lg
  `,

  fancyHoverEffect: `
    transition-transform hover:scale-105 hover:rotate-3 hover:shadow-lg
  `
};
